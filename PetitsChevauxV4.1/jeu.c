...
int DeplacementPion(int joueurDuTour, int scoreDes, int action, int pionDuTour,const char couleur[][6], Pion jeu[], SDL_Surface *ecran,  SDL_Rect positionBackground, SDL_Surface *background){//Fonction qui se charge de déplacer le pion
  printf("Valeur de l'action : %d\n ", action);
  switch(action){
    case 1:
